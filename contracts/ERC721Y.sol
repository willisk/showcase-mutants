...
/*
 * additions by phaze.eth
 */

abstract contract ERC721Y is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        require(ERC721Y.ownerOf(tokenId) == from, 'ERC721: transfer of token that is not own');
